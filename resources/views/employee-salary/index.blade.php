...
<div class="px-4 sm:px-6 lg:px-8">
    <div class="sm:flex sm:items-center">
        ...
        <div class="mt-4 sm:ml-16 sm:mt-0 sm:flex-none">
            <a href="{{ route('employee-salary.create') }}" class="block rounded-md bg-blue-600 px-3 py-2 text-center text-sm font-semibold text-white shadow-sm hover:bg-blue-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600">
                        ...
                        <tbody class="divide-y divide-gray-200 bg-white">
                            ...
                            <tr>
                                ...
                                <td class="relative whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6">
                                    <a href="{{ route('employee-salary.edit', $salary->id) }}" class="text-blue-600 hover:text-blue-900 mr-3" title="Edit">
                            ...
                            <tr>
                                <td colspan="7" class="px-3 py-8 text-center text-sm text-gray-500">
                                    ...
                                    <a href="{{ route('employee-salary.create') }}" class="mt-4 inline-flex items-center text-blue-600 hover:text-blue-900">
                                        Tambah konfigurasi gaji →
                                    </a>
                                </td>
                            </tr>
