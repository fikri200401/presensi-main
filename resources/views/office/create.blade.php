            ...
            <div>
                ...
                <div class="bg-blue-50 border border-blue-200 rounded-md p-3 mb-3">
                    <p class="text-sm text-blue-800">
                        ...
                        3️⃣ Or <strong>click anywhere on the map</strong> to set office location manually
                    </p>
                </div>
                ...
                <div class="mb-3 flex gap-2">
                    ...
                    <button type="button" onclick="resetMap()" 
                            class="inline-flex items-center px-4 py-2 bg-gray-600 text-white rounded-md shadow-sm text-sm font-medium hover:bg-gray-700 transition">
                        <svg class="w-5 h-5 mr-2" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div>
                        ...
                        <input type="number" step="any" id="latitude" name="latitude" value="{{ old('latitude', '-6.200000') }}" required readonly
                    ...
                    <div>
                        ...
                        <input type="number" step="any" id="longitude" name="longitude" value="{{ old('longitude', '106.816666') }}" required readonly
                               class="block w-full rounded-md border-gray-300 bg-gray-50 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 text-sm">
                    ...
                    <div>
                        ...
                        <input type="number" step="1" id="radius" name="radius" value="{{ old('radius', 100) }}" required
...
<script>
    ...
    const defaultRadius = {{ old('radius', 100) }};
    ...
    async function searchLocation(query) {
        ...
        try {
            ...
            // Bias search results towards Indonesia
    ...
    function resetMap() {
        ...
        showNotification('🔄 Map reset to default location (Jakarta)', 'info');
    }
