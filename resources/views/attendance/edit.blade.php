...
<div class="max-w-3xl">
    <div class="bg-white rounded-2xl border border-gray-100 shadow-sm overflow-hidden">
        <form method="POST" action="{{ route('attendance.update', $attendance) }}" class="p-6 space-y-5">
            @csrf
            @method('PUT')
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="any" id="schedule_latitude" name="schedule_latitude" value="{{ old('schedule_latitude', $attendance->schedule_latitude) }}" required
                ...
                <div>
                    ...
                    <input type="number" step="any" id="schedule_longitude" name="schedule_longitude" value="{{ old('schedule_longitude', $attendance->schedule_longitude) }}" required
                           class="block w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" id="schedule_start_time" name="schedule_start_time" value="{{ old('schedule_start_time', $attendance->schedule_start_time) }}" required
                           class="block w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none">
                ...
                <div>
                    ...
                    <input type="time" id="schedule_end_time" name="schedule_end_time" value="{{ old('schedule_end_time', $attendance->schedule_end_time) }}" required
                           class="block w-full rounded-xl border border-gray-200 bg-gray-50 px-3.5 py-2.5 text-sm focus:border-blue-500 focus:ring-2 focus:ring-blue-500/20 focus:outline-none">
