...
@section('page-title', 'Create New Attendance')

@section('content')
<div class="max-w-3xl">
    <div class="bg-white shadow-sm rounded-lg border border-gray-200">
        <form method="POST" action="{{ route('attendance.store') }}" class="p-6 space-y-6">
            @csrf
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="number" step="any" id="schedule_latitude" name="schedule_latitude" value="{{ old('schedule_latitude') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="number" step="any" id="schedule_longitude" name="schedule_longitude" value="{{ old('schedule_longitude') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
            ...
            <div class="grid grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="time" id="schedule_start_time" name="schedule_start_time" value="{{ old('schedule_start_time') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
                ...
                <div>
                    ...
                    <input type="time" id="schedule_end_time" name="schedule_end_time" value="{{ old('schedule_end_time') }}" required class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm">
