...
<div class="mb-6 border-b border-gray-200">
    <nav class="flex gap-0 -mb-px overflow-x-auto">
        ...
        @endcan
        @can('view_any_division')
        <a href="{{ route('division.index') }}" class="{{ request()->routeIs('division.*') ? 'border-blue-600 text-blue-600' : 'border-transparent text-gray-500 hover:text-gray-700 hover:border-gray-300' }} whitespace-nowrap border-b-2 px-4 py-3 text-sm font-medium transition-colors">
            Divisi
        </a>
        @endcan
    </nav>
